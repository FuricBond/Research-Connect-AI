...
class RiskScoringConfig:
    ...
    provenance_weights: dict[EvidenceProvenance, float] = field(
        default_factory=lambda: {
            ...
            EvidenceProvenance.GRAPH_ANALYSIS: 0.85,
    ...
    negative_signal_weights: dict[str, float] = field(
        default_factory=lambda: {
            ...
            EvidenceSignal.HIGH_ORGANIZER_REUSE.value: 0.35,
            EvidenceSignal.HIGH_DOMAIN_REUSE.value: 0.35,
            EvidenceSignal.GRAPH_IDENTITY_CONFLICT.value: 0.30,
            EvidenceSignal.SUSPICIOUS_ORGANIZER_CLUSTER.value: 0.50,
            EvidenceSignal.SUSPICIOUS_PUBLISHER_CLUSTER.value: 0.50,
    ...
    positive_signal_weights: dict[str, float] = field(
        default_factory=lambda: {
            ...
            EvidenceSignal.CONSISTENT_GRAPH_IDENTITY.value: 0.20,
    ...
    signal_groups: dict[str, str] = field(
        default_factory=lambda: {
            ...
            EvidenceSignal.HIGH_ORGANIZER_REUSE.value: "GENERAL",
            EvidenceSignal.HIGH_DOMAIN_REUSE.value: "DOMAIN",
            EvidenceSignal.GRAPH_IDENTITY_CONFLICT.value: "EDITORIAL",
            EvidenceSignal.SUSPICIOUS_ORGANIZER_CLUSTER.value: "GENERAL",
            EvidenceSignal.SUSPICIOUS_PUBLISHER_CLUSTER.value: "PUBLISHER",
